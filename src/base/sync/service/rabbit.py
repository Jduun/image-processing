...
from src.base.sync.models import (
    RabbitFullConfig,
...
class RabbitService:
    ...
    def __init__(
        ...
        config: t.Union[
            RabbitFullConfig,
            t.Union[RabbitConsumerConfig, RabbitPublisherConfig],
        ],
    ):
        self._config = config
    ...
    def _receiver_proxy(self, receiver):
        def _handle_message(
            ch: BlockingChannel,
            ...
            try:
                ...
                if "id" not in message:
                    raise ValueError("Нет ключа 'id' в сообщении")
            except Exception as e:
            ...
            try:
                ...
                with self._queue_connection() as channel:
                    ...
                    channel.queue_declare(
                        ...
                        durable=True,
                        arguments={
                            "x-max-priority": self._config.max_priority
                        },
                    )
                    channel.basic_consume(
                        ...
                        auto_ack=False,
                        exclusive=False,
                        on_message_callback=self._receiver_proxy(receiver),
                    )
